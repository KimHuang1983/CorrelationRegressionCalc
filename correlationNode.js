class Correlation {
    ...
    getCorrelation() {
        ...
        if (!this.dataLength()) {
            ...
            this.calcSums()
            result = ((this.n * this.sumOfArrayXY - this.sumOfArrayX * this.sumOfArrayY) / Math.sqrt((this.n * this.sumOfArraySqrX - Math.pow(this.sumOfArrayX, 2)) * (this.n * this.sumOfArraySqrY - Math.pow(this.sumOfArrayY, 2)))).toFixed(10)
            return result
        }
    }
}
